...
To perform our sentiment analysis, we used Higging Faces transformers feature using pipeline and specifying sentiment-analysis. This package streamlined the process of evaluating messages. It was challenging to understand how the process worked, we wanted to fully understand the power of what we were applying. We dove in to documentation and used online explanations of hwo the algorithm tokenized values, passed the data through transformers, completed classification, and outputed the sentiment. Overall, the package made it extremely easy to analyze the data and visualize our message. Additionally, it was challenging to ensure that we had the proper format to create the query and map the text to keywords related to each mogul and their company.
